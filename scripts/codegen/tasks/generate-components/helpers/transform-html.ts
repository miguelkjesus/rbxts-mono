// modified from https://github.com/roblox-ts/types/blob/master/src/util/transformHtml.ts
...
function getChildren(node: Element) {
  return node.children.filter(
    (child) => child.type !== ElementType.Text || child.nodeValue.trim() !== ''
  )
}
...
export default function transformHtml(content: string) {
